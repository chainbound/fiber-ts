...
proto.api.TxSequenceMsg.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(1, f, eth_pb.Transaction.serializeBinaryToWriter);
  }
};
...
proto.api.BlockSubmissionMsg.prototype.getSszBlock_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getSszBlock()));
};
...
proto.api.TransactionMsg.prototype.getRlpTransaction_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getRlpTransaction()));
};
...
proto.api.TransactionMsg.prototype.getRlpTransaction_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getRlpTransaction()));
};
...
proto.api.ExecutionPayloadMsg.prototype.getSszPayload_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getSszPayload()));
};
...
proto.api.BlockSubmissionResponse.prototype.getStateRoot_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getStateRoot()));
};

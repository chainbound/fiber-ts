...
interface IAPIService_ISubscribeNewTxsV2 extends grpc.MethodDefinition<api_pb.TxFilter, api_pb.TransactionWithSenderMsg> {
...
interface IAPIService_ISendTransactionV2 extends grpc.MethodDefinition<api_pb.TransactionMsg, api_pb.TransactionResponse> {
...
interface IAPIService_ISendTransactionSequenceV2 extends grpc.MethodDefinition<api_pb.TxSequenceMsgV2, api_pb.TxSequenceResponse> {
...
interface IAPIService_ISubscribeExecutionPayloadsV2 extends grpc.MethodDefinition<google_protobuf_empty_pb.Empty, api_pb.ExecutionPayloadMsg> {
...
interface IAPIService_ISubscribeBeaconBlocksV2 extends grpc.MethodDefinition<google_protobuf_empty_pb.Empty, api_pb.BeaconBlockMsg> {
...
interface IAPIService_ISubmitBlockStream extends grpc.MethodDefinition<api_pb.BlockSubmissionMsg, api_pb.BlockSubmissionResponse> {
...
export interface IAPIServer extends grpc.UntypedServiceImplementation {
    ...
    subscribeNewTxsV2: grpc.handleServerStreamingCall<api_pb.TxFilter, api_pb.TransactionWithSenderMsg>;
    ...
    sendTransactionV2: grpc.handleBidiStreamingCall<api_pb.TransactionMsg, api_pb.TransactionResponse>;
    sendTransactionSequence: grpc.handleBidiStreamingCall<api_pb.TxSequenceMsg, api_pb.TxSequenceResponse>;
    sendTransactionSequenceV2: grpc.handleBidiStreamingCall<api_pb.TxSequenceMsgV2, api_pb.TxSequenceResponse>;
    ...
    subscribeExecutionPayloadsV2: grpc.handleServerStreamingCall<google_protobuf_empty_pb.Empty, api_pb.ExecutionPayloadMsg>;
    ...
    subscribeBeaconBlocksV2: grpc.handleServerStreamingCall<google_protobuf_empty_pb.Empty, api_pb.BeaconBlockMsg>;
    submitBlockStream: grpc.handleBidiStreamingCall<api_pb.BlockSubmissionMsg, api_pb.BlockSubmissionResponse>;
}
...
export interface IAPIClient {
    ...
    subscribeNewTxsV2(request: api_pb.TxFilter, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<api_pb.TransactionWithSenderMsg>;
    subscribeNewTxsV2(request: api_pb.TxFilter, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<api_pb.TransactionWithSenderMsg>;
    ...
    sendTransactionV2(): grpc.ClientDuplexStream<api_pb.TransactionMsg, api_pb.TransactionResponse>;
    sendTransactionV2(options: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<api_pb.TransactionMsg, api_pb.TransactionResponse>;
    sendTransactionV2(metadata: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<api_pb.TransactionMsg, api_pb.TransactionResponse>;
    ...
    sendTransactionSequenceV2(): grpc.ClientDuplexStream<api_pb.TxSequenceMsgV2, api_pb.TxSequenceResponse>;
    sendTransactionSequenceV2(options: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<api_pb.TxSequenceMsgV2, api_pb.TxSequenceResponse>;
    sendTransactionSequenceV2(metadata: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<api_pb.TxSequenceMsgV2, api_pb.TxSequenceResponse>;
    ...
    subscribeExecutionPayloadsV2(request: google_protobuf_empty_pb.Empty, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<api_pb.ExecutionPayloadMsg>;
    subscribeExecutionPayloadsV2(request: google_protobuf_empty_pb.Empty, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<api_pb.ExecutionPayloadMsg>;
    ...
    subscribeBeaconBlocksV2(request: google_protobuf_empty_pb.Empty, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<api_pb.BeaconBlockMsg>;
    subscribeBeaconBlocksV2(request: google_protobuf_empty_pb.Empty, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<api_pb.BeaconBlockMsg>;
    submitBlockStream(): grpc.ClientDuplexStream<api_pb.BlockSubmissionMsg, api_pb.BlockSubmissionResponse>;
    submitBlockStream(options: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<api_pb.BlockSubmissionMsg, api_pb.BlockSubmissionResponse>;
    submitBlockStream(metadata: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<api_pb.BlockSubmissionMsg, api_pb.BlockSubmissionResponse>;
}
...
export class APIClient extends grpc.Client implements IAPIClient {
    ...
    public subscribeNewTxsV2(request: api_pb.TxFilter, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<api_pb.TransactionWithSenderMsg>;
    public subscribeNewTxsV2(request: api_pb.TxFilter, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<api_pb.TransactionWithSenderMsg>;
    ...
    public sendTransactionV2(options?: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<api_pb.TransactionMsg, api_pb.TransactionResponse>;
    public sendTransactionV2(metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<api_pb.TransactionMsg, api_pb.TransactionResponse>;
    ...
    public sendTransactionSequenceV2(options?: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<api_pb.TxSequenceMsgV2, api_pb.TxSequenceResponse>;
    public sendTransactionSequenceV2(metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<api_pb.TxSequenceMsgV2, api_pb.TxSequenceResponse>;
    ...
    public subscribeExecutionPayloadsV2(request: google_protobuf_empty_pb.Empty, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<api_pb.ExecutionPayloadMsg>;
    public subscribeExecutionPayloadsV2(request: google_protobuf_empty_pb.Empty, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<api_pb.ExecutionPayloadMsg>;
    ...
    public subscribeBeaconBlocksV2(request: google_protobuf_empty_pb.Empty, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<api_pb.BeaconBlockMsg>;
    public subscribeBeaconBlocksV2(request: google_protobuf_empty_pb.Empty, metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientReadableStream<api_pb.BeaconBlockMsg>;
    public submitBlockStream(options?: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<api_pb.BlockSubmissionMsg, api_pb.BlockSubmissionResponse>;
    public submitBlockStream(metadata?: grpc.Metadata, options?: Partial<grpc.CallOptions>): grpc.ClientDuplexStream<api_pb.BlockSubmissionMsg, api_pb.BlockSubmissionResponse>;
}
